{'targets': [{
  ...
  , 'sources': [
      ...
      , 'leveldb-<(ldbversion)/include/leveldb/atomics.h'
      ...
      , 'leveldb-<(ldbversion)/include/leveldb/expiry.h'
      ...
      , 'leveldb-<(ldbversion)/include/leveldb/perf_count.h'
      ...
      , 'leveldb-<(ldbversion)/port/atomic_pointer.h'
      , 'leveldb-<(ldbversion)/port/port.h'
      , 'leveldb-<(ldbversion)/port/thread_annotations.h'
      , 'leveldb-<(ldbversion)/port/win/stdint.h'
      ...
      , 'leveldb-<(ldbversion)/util/cache2.h'
      ...
      , 'leveldb-<(ldbversion)/util/refobject_base.h'
      , 'leveldb-<(ldbversion)/util/status.cc'
      , 'leveldb-<(ldbversion)/util/thread_tasks.cc'
      , 'leveldb-<(ldbversion)/util/thread_tasks.h'
      , 'leveldb-<(ldbversion)/util/throttle.cc'
      , 'leveldb-<(ldbversion)/util/throttle.h'
    ]
}]}
